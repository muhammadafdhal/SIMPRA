                            ...
                            <table id="example" class="table table-hover" border="1" style="width:100%">
                                ...
                                <tbody align="center">
                                    ...
                                    <tr>
                                        ...
                                        @if (Auth::user()->us_level=='Admin')
                                        @if ($t->md_status_nilai == "Belum")
                                        <td class="datatable-ct">
                                            <a href="/nilai/tambah/{{ $t->md_id }}" class="btn btn-info">Input Nilai</a>
                                        </td>
                                        @else
                                            <td> <span class="badge badge-success">Nilai Sudah Dimasukan</span></span></td>
                                        @endif
